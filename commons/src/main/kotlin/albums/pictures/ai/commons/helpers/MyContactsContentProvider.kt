...
import albums.pictures.ai.commons.extensions.getIntValue
import albums.pictures.ai.commons.extensions.getStringValue
import albums.pictures.ai.commons.models.PhoneNumber
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "albums.pictures.ai.commons.contactsprovider"
