...
import albums.pictures.ai.commons.models.SharedTheme

class MyContentProvider {
    companion object {
        private const val AUTHORITY = "albums.pictures.ai.commons.provider"
        const val SHARED_THEME_ACTIVATED = "albums.pictures.ai.commons.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "albums.pictures.ai.commons.SHARED_THEME_UPDATED"
